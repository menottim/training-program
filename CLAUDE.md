...
__The game slate changes by season. Check it. Do not assume it.__ The standard in-season slate is basketball on Tuesday PM and Sunday AM, plus hockey on Sunday PM. Much of this file assumes that three-game week. Section 5 session spacing and the Section 3 volume ceiling both do. The three-game week is not always correct. __As of 2026-08-16 the slate is a two-game Sunday: basketball AM, then hockey PM. There is no Tuesday game.__ Basketball returned on 8/16 after 56 days out with the calf strain, and both Sunday games were symptom-free. Two games on one day is not the same constraint as three games across a week: the sport load is concentrated, so Sunday needs a clean run-up rather than the whole week held light. The current slate is always in `data.modifiedWeeks`. If it is unclear, ask. Do not inherit the three-game assumption.
