# Supplements: Athlete-Calibrated Evidence Review
...
Evidence for omega-3 in athletes is Moderate but supports doses meaningfully higher than Menotti's current 980mg EPA+DHA:

- __Muscle recovery / DOMS__ (Jouris et al. 2011; Tsuchiya et al. 2020; multiple RCTs): effective doses for reducing post-exercise muscle damage markers and perceived soreness range from __2,000 to 4,200 mg EPA+DHA daily__. Most studies use 2-3 g/day minimum for 4+ weeks.
- __Tendon healing__ (Irani et al. 2025, Am J Sports Med, PMID 40376939): omega-3 + exercise improved Achilles tendon collagen alignment and cell arrangement in animal model. Human clinical data is Emerging.
- __Cardiovascular / triglyceride benefits__ (AHA guidelines): 1g/day EPA+DHA for general CVD prevention; 2-4g/day for triglyceride lowering.
- __Upper safe limit__: FDA generally recognizes up to 3 g/day EPA+DHA as safe for general consumption. European EFSA accepts up to 5 g/day.

__Practical recommendation (Evidence tier: Moderate):__ Current 980mg dose is at the low end for general CV benefit and __likely below threshold for muscle-recovery or tendon-specific effects__. Doubling to ~2g EPA+DHA daily is reasonable if tendon/recovery support is a priority. Check the label for total EPA+DHA content (not total fish oil mg) and aim for 2,000-3,000mg EPA+DHA.

### 3. Magnesium glycinate 240mg is well-chosen

Dose and form both supported by evidence:

- __Form (Mayo Clinic Press review 2023; Banner Health)__: magnesium glycinate has better GI tolerance than magnesium oxide or citrate, with fewer loose-stool side effects.
- __Dose__: 200-400mg elemental magnesium is the typical supplemental range. 240mg sits comfortably in that range.
- __Sleep quality evidence (Moderate)__: several small RCTs show modest sleep quality improvement in older adults and magnesium-deficient populations. Effect in non-deficient adults is smaller.
...
- __Evidence (Weak)__: ISSN and ACSM guidance converge on "multivitamins do not improve performance in athletes with adequate diet" (Aragon et al. 2017 ISSN position stand). Where there's benefit, it's in populations with specific deficiencies, weight-controlled sports with energy restriction, or restrictive diets.
- __Potential downside__: some multivitamin formulations contain iron, which would compound with the separate iron supplement. __Check the label.__ The standard One A Day Men's Health Formula generally contains 0 mg iron (unlike women's formulations), but verify on the bottle.
- __Antioxidant caution__: recent consensus (Merry & Ristow 2016; ISSN 2017) flags that high-dose vitamin C and E supplementation in the peri-workout window can __blunt mitochondrial biogenesis and redox signaling__, reducing training adaptation. One A Day contains moderate doses of C (60-90mg) and E (30 IU) that are unlikely to cause this effect, but it's worth awareness.

__Practical recommendation:__ Neutral. If diet already includes vegetables, fruits, lean proteins, and whole grains, the multivitamin is redundant. If diet coverage is uncertain, it's cheap insurance. Not harmful if iron content is verified at 0mg (avoid compounding with separate iron supplement).

## Commonly Asked Alternatives and Their Evidence

### Vitamin D

- __Evidence (Strong)__: Vitamin D deficiency is highly prevalent in athletes, especially indoor-sport and winter-training athletes. Correction improves VO2 max in deficient athletes and may support tendon health and immune function.
- __Recommendation__: __Test, don't guess.__ Serum 25-OH-vitamin-D level should be ≥30 ng/mL (75 nmol/L), ideally 40-60 ng/mL. If below, supplement 1,000-5,000 IU/day based on deficiency depth. If above, no supplementation needed.
- __Menotti context__: Lives in San Diego (latitude ~32°N), outdoor basketball year-round. Likely adequate without supplement, but a one-time 25-OH-D test at next physician visit is a free data point.
...
- __Evidence (Strong)__: ISSN position stand (Guest et al. 2021) supports 3-6 mg/kg body weight (~300-600 mg for Menotti) 30-60 min pre-exercise for performance, with effects on endurance, power, and alertness.
- __Caution__: chronic high-dose caffeine near bedtime disrupts sleep (half-life ~5-6h). Limit intake after ~2 PM if sleep is a priority.

### Beta-alanine, citrulline malate, beetroot

- __Beta-alanine__: Strong evidence for high-intensity exercise 1-4 min in duration (ISSN position stand). Less relevant for basketball/hockey game performance; more relevant for high-intensity intervals.
- __Citrulline malate 6-8g pre-workout__: Moderate evidence for volume-based resistance training performance. Worth an experimental 4-week trial if interested; likely trivial effect size for current goals.
- __Beetroot juice (nitrates)__: Strong for endurance, Moderate for team sports. 500mL ~2 hours pre-game may improve repeated-sprint performance. Experimental.

### Common stacks without solid evidence

- __BCAAs (branched-chain amino acids)__: Not worth the money for athletes hitting 1.6-2.2 g/kg total protein. Total protein beats isolated BCAAs for muscle protein synthesis (Morton 2018).
- __Glutamine__: Minimal evidence for performance or recovery outside clinical immune contexts.
- __Arginine / AAKG__: Weak evidence outside clinical cardiovascular populations.
- __Peptides (BPC-157, TB-500)__: No human RCTs; veterinary and rodent data only. Legal status ambiguous. Not recommended.
- __Prohormones, SARMs, TRT__: Out of scope for this program. If considering due to age-related symptoms, get comprehensive hormone panels and work with a physician.
...
3. __Confirm One A Day Men's contains 0mg iron__. If it contains any iron, that compounds the iron-overload risk above and should influence the iron-supplement decision.

4. __Consider adding collagen peptides + vit C pre-loading__ as an Emerging-evidence adjunct for Achilles tendinopathy. 10-15g collagen peptides + 50mg vit C, 30-60 min before HSR or sport.

5. __Test vitamin D at next physician visit__ rather than supplement blindly. Lives in sunny San Diego, likely sufficient, but one-time test is a cheap data point.

6. __Keep magnesium glycinate and creatine as-is.__ Both well-calibrated.

## Unresolved or Bleeding-Edge

- __Collagen-for-tendon clinical endpoints__: mechanism is strong but well-powered RCTs with VISA-A or equivalent outcomes are still small. Worth trialing but not yet consensus-tier.
- __Omega-3 optimal dose for tendon vs muscle outcomes__: range is wide (1.8-6g/day) and studies use inconsistent endpoints.
- __Peri-workout antioxidant blunting__: vitamin C/E at high doses near training appears to blunt adaptation. Dose-response and timing thresholds are still being characterized.
- __Individual iron needs vary__: plant-based athletes, female athletes, or endurance athletes with repeated foot-strike hemolysis have higher iron turnover. Menotti's profile (male, meat-eating, mixed-sport) is at lower iron-loss risk than those populations.
...
11. Holick MF. __Vitamin D deficiency.__ New England Journal of Medicine, 2007; 357(3): 266-281. (Reference for 25-OH-D thresholds.)
